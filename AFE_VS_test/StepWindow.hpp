...
public:
	...
	*/
	...
	void ConvertAngle(float angle,bool twin);
...
private:
	...
	float QuadCoef = 1;//Коэффицент квадратурного напряжения 232Б
	float ICoef = 1;//Коэффицент силы тока 232Б
	float UCoef = 1;//Коэффицент напряжения 232Б
	float MinCoef = 30;//Минимальное проходное напряжения 232Б
	int Diap[5][2] = { {0,20},//Диапазоны поиска минимумов 45д20
					{45,65},
					{90,110},
					{180,200},
					{270,290} };
	int Diap265[8][2] = { {0,20},//Диапазоны поиска минимумов 265Д
						{45,65},
						{90,110 },
						{135,155},
						{180,200},
						...
						{270,290},
						{315,335} };
	int Diap232[5][2] = { {0,20},
						{45,65},
						{90,110},
						{180,200},
						{270,290} };
	int Ind265[8] = { 0,1,2,5,6,7,8,9 };//Индексы заполнения градусов в таблицу 265Д
	int Ind[13] = { 0,0,2,2,3,3,4,4,1,1,0,2,1 };//Индексы заполнения градусов в таблицу 232Б
